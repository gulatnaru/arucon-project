...
| DQ-09 환경 | macOS 도구 재조사·가능한 local generation/parse | SDK/시뮬레이터/기기 준비 |
...
- 설치된 CLT/Swift와 Java는 사용할 수 있으나 full Xcode/iOS Simulator·Android SDK/emulator가 없다. 정확한 환경/명령은 approved-mvp evidence를 따른다.

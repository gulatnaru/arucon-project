...
export const DEFAULT_NOTIFICATION_POLICY = Object.freeze({
  ...
  decision: 'DEC-14' as const,
  enabled: false as const,
});

/** Copy can be reviewed locally while every operational delivery path remains disabled. */
...
export function requireOperationalNotificationPolicy(): never {
  throw new NotificationDecisionRequired();
}
